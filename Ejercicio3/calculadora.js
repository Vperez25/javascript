var num1, num2, numAux, esResultado = false, esResultadoError = false; operador = null;
   ...
   if(operador != null){
       ...
       if(operador === "+"){
           ...
           if(num2 > 0){
               ...
               displayUpper.innerText= "No se puede dividir entre 0";
       ...
       if(esResultadoError){
           historialPara.textContent = "No se puede dividir entre 0";
